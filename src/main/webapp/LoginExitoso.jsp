                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="RegistrarIntercambio.html">Crear intercambio<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
                        ...
                        <tbody>
                            <c:forEach 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${Intercambios.entidad.fechaIntercambio}"/> 
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-xs"
                                           href="IntercambioServlet?accion=ver&id=<c:out value="${Intercambios.entidad.idIntercambio}"/>">
                                            Ver Intercambio
                                        </a>
                                    </td>
